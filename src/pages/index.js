...
export default function Home() {
  return (
    <div id='main' className='m-4 rounded-lg bg-purple-600'>

      <nav className="bg-white border-gray-200 dark:bg-transparent dark:border-gray-700 ">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-transparent md:dark:bg-transparent dark:border-gray-700">
              <li>
      ...
      <div className=' container grid grid-flow-row m-24 p-24'>
      
      <div className=' container grid grid-flow-col '>
        <div className="container grid grid-flow-row text-center">
          <div>
          <h1 className=' text-white text-2xl'>Hi there I'M using WhatsApp and Instagram</h1>
          </div>
          <div>
            <button type='button' className=' w-20 h-auto rounded-2xl bg-red-500'>Click</button>
          </div>
        </div>
        <div className="container flex justify-center items-center">
          <div>
          <Image src={img} alt="img not found" srcset="" className=' h-48 w-48'/>
        </div>
        </div>
      </div>
      <div className="container grid grid-flow-col mt-4 p-6">
        <div>
        <h1 className=' text-white text-lg'>Marketing partner</h1>
        </div>
        <div>
        <h1 className=' text-white text-lg'>Marketing partner</h1>
        </div>
